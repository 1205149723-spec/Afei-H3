...
class MiniMaxH3(BaseModel):
    ...
    def extra_conds(self, **kwargs):
        ...
        # H3 builds PackedLayout in the diffusion model from the actual
        # video/audio latent shapes received by each forward call.  Do not
        # cache a second target layout from latent_shapes here: that would
        # give target duration two competing sources in the R2V path.
